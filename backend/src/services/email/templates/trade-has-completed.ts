...
const buildTradeSuccessfulEmail = (trade: any, user: any) => {
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="100%"
    ...
    <tr>
      <td style="padding: 30px 40px;">
        ...
        <p style="margin:0 0 20px;color:#333333;font-size:16px;line-height:24px;">
          Your trade with <strong>${trade.trader.firstName} ${trade.trader.lastName}</strong> (${trade.trader.username}) was successful.
        </p>
...
export default buildTradeSuccessfulEmail;
