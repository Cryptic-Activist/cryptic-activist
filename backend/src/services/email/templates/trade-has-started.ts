...
const buildTradeStartedEmail = (trade: any) => {
    ...
    <tr>
      <td style="padding: 30px 40px;">
        <p style="margin:0 0 20px;color:#333333;font-size:16px;line-height:24px;">
          Hi <strong>${trade.vendor.firstName} ${trade.vendor.lastName}</strong>,
        </p>
        <p style="margin:0 0 20px;color:#333333;font-size:16px;line-height:24px;">
          Your trade with <strong>${trade.trader.firstName} ${trade.trader.lastName}</strong> (@${trade.trader.username}) has just begun.
        </p>
...
export default buildTradeStartedEmail;
