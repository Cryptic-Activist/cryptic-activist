/*
  ...
  - You are about to drop the column `abiUrl` on the `smart_contracts` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "smart_contracts" DROP COLUMN "abiUrl",
