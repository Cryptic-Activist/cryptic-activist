...
CREATE TABLE "cryptocurrecies" (
    ...
    CONSTRAINT "cryptocurrecies_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "cryptocurrecies_coingeckoId_key" ON "cryptocurrecies"("coingeckoId");

-- CreateIndex
CREATE UNIQUE INDEX "cryptocurrecies_symbol_key" ON "cryptocurrecies"("symbol");
...
-- AddForeignKey
ALTER TABLE "offers" ADD CONSTRAINT "offers_cryptocurrencyId_fkey" FOREIGN KEY ("cryptocurrencyId") REFERENCES "cryptocurrecies"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
