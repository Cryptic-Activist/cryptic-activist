...
export interface ERC20EscrowInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "autoCancelTrades"
      | "buyerFundTrade"
...
export interface ERC20Escrow extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20Escrow;
