import {
  UploadChatMessageFilesParams,
  UploadEvidenceFilesParams,
...
export const uploadChatMessageFiles = async (
  params: UploadChatMessageFilesParams
) => {
  try {
    const bearerToken = getBearerToken();
    params.formData.append('folder', `chat/${params.chatId}/messages`);
